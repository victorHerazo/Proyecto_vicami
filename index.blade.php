    ...
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/1.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Bienvenido a <span>Sisprova</span></h1>
            <p class="animated fadeInRightBig">Proyecto Sisprova - ADSI 111 - SENA- 2016</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Empiece ahora</a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">
           <img class="img-responsive" src="images/logo.png" alt="logo" width="80px" height="80px">
          </a>                    
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            <li class="scroll active"><a href="#home">Inicio</a></li>
            <li class="scroll"><a href="#services">Registrar</a></li> 
            <li class="scroll"><a href="#services">Personas</a></li> 
            <li class="scroll"><a href="equipos">Equipos</a></li> 
            <li class="scroll"><a href="elementos">Elementos</a></li>  
            <li class="scroll"><a href="roles">Roles</a></li>  
            <li class="scroll"><a href="marcas">Marcas</a></li>  
            <li class="scroll"><a href="#about-us">Acerca del proyecto</a></li>                     
